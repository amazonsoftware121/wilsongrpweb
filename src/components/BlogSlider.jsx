                                ...
                                >
                                    <Card variant="" sx={{ height: '100%', display: 'flex', padding: '20px', borderRadius: '15px', border: '1px solid #CCCCCC', flexDirection: 'column', justifyContent: 'space-between', gap: '15px', backgroundColor: 'transparent' }}>
                                        ...
                                        <CardMedia
                                            ...
                                            title="green iguana"
                                        />
                                        <Typography sx={{ padding: '4px 29px', position: 'absolute', bottom: '15px', right: '20px', textTransform: 'uppercase', color: '#fff', fontWeight: 500 }} bgcolor='primary.main' className='subtitle' gutterBottom>{slide.cat}</Typography>
                                        </Box>
                                        <CardContent sx={{ height: '150px',overflow: 'hidden',  padding: '10px 10px 0 10px', position: 'relative' }}>
